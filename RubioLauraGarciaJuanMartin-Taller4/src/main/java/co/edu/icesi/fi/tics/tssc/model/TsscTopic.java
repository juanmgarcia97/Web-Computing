...
public class TsscTopic implements Serializable {
	...
	@NotBlank(groups = TsscTopicValidation.class)
	private String description;

	@NotBlank(groups = TsscTopicValidation.class)
	private String name;

	@Min(value = 1, groups = TsscTopicValidation.class)
	...
	public TsscTimecontrol removeTsscTimecontrol(TsscTimecontrol tsscTimecontrol) {
		getTsscTimecontrol().remove(tsscTimecontrol);
